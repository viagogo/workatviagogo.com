...
Repository.prototype.getContainer = function(index) {
  ...
  return [
    '<div class="', this.language, ' ', this.classes(), ' ', last, '">',
      this.featuredImage(),
      this.repoContent(),
      this.bottomLinks(),
    '</div>'
...
Repository.prototype.repoContent = function() {
  return [
    '<div class="gCol4 mbl">',
      '<div class="tile h uus">',
          '<h3>',
            '<a href="', this.url, '" target="_blank">', this.headerLogo(), this.name, '</a>',
          '</h3>',
          '<div class="repo-info">',
            '<span class="mrm"><i class="octicon octicon-star"></i> ', this.watchers, '</span> ',
            '<span class="mrm"><i class="octicon octicon-repo-forked"></i> ', this.forks, '</span>',
            '<span class="mrm language ', this.language ,'">', this.language, '</span>',
          '</div>',
          '<p class="mtm">', this.description, '</p>',
      '</div>',
    '</div>'
  ].join('');
}
